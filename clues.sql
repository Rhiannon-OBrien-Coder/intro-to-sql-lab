...
-- Southern Europe. She's most likely traveling someplace where she won't be noticed, so find the least populated
...
-- be too obvious. We're following our gut on this one; find out what other city in that country she might be
-- flying to.
...
-- parts of the globe! She's headed to South America as we speak; go find a city whose name is like the one we
-- were headed to, but doesn't end the same. Find out the city, and do another search for what country it's in. Hurry!
...
-- landing dock. Lucky for us, she's getting cocky. She left us a note (below), and I'm sure she thinks she's very
-- clever, but if we can crack it, we can finally put her where she belongs – behind bars.
